        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Beneficiary_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_KYCRequests_KYCStatuses_KYCStatusId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WalletBalances_Currencies_CurrencyCode",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReversalTransactionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reversals_Transactions_OriginalTransactionId",
                        column: x => x.OriginalTransactionId,
                        principalTable: "Transactions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reversals_Transactions_ReversalTransactionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DisputeMessage_DisputeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KYCRequests_KYCStatusId",
                table: "KYCRequests",
                column: "KYCStatusId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reversals_OriginalTransactionId",
                table: "Reversals",
                column: "OriginalTransactionId");

            migrationBuilder.CreateIndex(
                name: "IX_Reversals_ReversalTransactionId",
                table: "Reversals",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WalletBalances_CurrencyCode",
